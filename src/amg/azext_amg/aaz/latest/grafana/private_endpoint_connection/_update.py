...
@register_command(
    "grafana private-endpoint-connection update",
)
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.group_ids = AAZListArg(
            ...
            help="The private endpoint connection group ids.",
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.PrivateEndpointConnectionsApprove(ctx=self.ctx)()
    ...
    class PrivateEndpointConnectionsApprove(AAZHttpOperation):
        ...
        def _build_schema_on_201(cls):
            ...
            group_ids = cls._schema_on_201.properties.group_ids
            group_ids.Element = AAZStrType()

            private_endpoint = cls._schema_on_201.properties.private_endpoint
            private_endpoint.id = AAZStrType(
                flags={"read_only": True},
            )

            private_link_service_connection_state = cls._schema_on_201.properties.private_link_service_connection_state
